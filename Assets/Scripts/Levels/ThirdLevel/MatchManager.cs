...
{   
	public class MatchManager : MonoBehaviour
	{
    	...
    	public AudioClip audioClipDo;
		public AudioClip audioClipRe;
		public AudioClip audioClipMi;
		public AudioClip audioClipFa;
		public AudioClip audioClipSol;
		public void Start()
		{
			/*instance = this;
			...
			// Prefab'ı Instantiate eder ve bir değişkene atar
			GameObject createdObject = (GameObject)Instantiate(Resources.Load("Prefabs/SampleObject"));
			// Oluşturulan objenin referansını saklar
			matchPieceObject = createdObject;
			// Oluşturulan objeyi deaktif eder
