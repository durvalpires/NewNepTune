...
namespace MidiPlayerTK
{
    ...
    public partial class MidiSynth : MonoBehaviour
    {
        ...
        /// <summary>
        /// Delay in milliseconds the MIDI thread waits before reading MIDI events.
        /// </summary>
        ...
        */
        ...
        //        {
        //            //Debug.Log($"fluid_synth_noteoff Channel:{pchan} key:{pkey} Isloop:{voice.IsLoop} Ignore:{keepPlayingNonLooped} Na�e:{voice.sample.Name}");
        ...
        public static StringBuilder MPTK_BuildInfoSynth(MidiSynth synth)
        {
            try
            {
                ...
                logSynthInfo.Clear();
                logSynthInfo.Append($"Maestro Mode:          {(synth.MPTK_CorePlayer ? "Core" : "AudioSource")}\t{synth.AudioEngine}\tRate:{synth.OutputRate}\tBuffer:{synth.DspBufferSize}");
        ...
        //    logsSynthInfo[line].Insert(col * 20, info);
        //}
